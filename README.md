...
| `type` | `'root' or 'umd' or 'amd' or 'commonjs' or 'commonjs2'` | true | Force this module to a specific method or resolution. For AMD style require use `umd` or `amd`. For node style require use `commonjs`, and to access the object as a global use `root` |
